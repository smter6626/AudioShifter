...
- 正式公开 alpha.3 之前，由项目所有者审核 Draft 的原生 License 菜单、完整 GPL 窗口、许可证/品牌范围、Release notes、附件和 SHA-256，并在非开发 Apple Silicon Mac 完成人工验收；alpha.1 和 alpha.2 内部 Draft 保持不变，是否进入 Developer ID 签名与 Apple 公证阶段仍另行决定。
